...
const page = () => {
  ...
  return (
    <>
      <h1 className='bg-black text-white p-5 text-5xl font-bold text-center'>Manoranjan Todo List</h1>
      <form onSubmit={submitHandler}>
        <input type='text' className='text-2xl border-zinc-800 border-2 m-5 px-4 py-2 ' placeholder='Enter Your Task' value={title} onChange={(e) => { settitle(e.target.value) }} />
